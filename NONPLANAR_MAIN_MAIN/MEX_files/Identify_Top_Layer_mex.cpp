...
Eigen::MatrixXd identify_top_layer(Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd);
...
void mexFunction (int _OutArgs, mxArray *MatlabOut[], int _InArgs, const mxArray *MatlabIn[] )
{
    ...
    // Method 
    Eigen::MatrixXd fnew = identify_top_layer( v, f, n);
...
Eigen::MatrixXd identify_top_layer(Eigen::MatrixXd v, Eigen::MatrixXd f, Eigen::MatrixXd n)
{
