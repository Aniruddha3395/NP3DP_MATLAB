...
Eigen::MatrixXd Infill_Path_with_Normals(Eigen::MatrixXd, double, double, double, double, double, int);
...
void mexFunction (int _OutArgs, mxArray *MatlabOut[], int _InArgs, const mxArray *MatlabIn[] )
{
    ...
    // Method 
    Eigen::MatrixXd tool_path = Infill_Path_with_Normals(fillpts, FlipTravel, space, hatch_angle, x_avg, y_avg, (int) skip_lines);
...
Eigen::MatrixXd Infill_Path_with_Normals(Eigen::MatrixXd fillpts, double FlipTravel, double space, double hatch_angle, double x_avg, double y_avg, int skip_lines)
{
