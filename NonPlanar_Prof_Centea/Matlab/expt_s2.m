...
%%%%%%%%%%%%%%%% travelling with positive slope %%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%
storesorts2tp = [storesorts2,thetax,thetay];

storesorts2tp = storesorts2tp(1:6:size(storesorts2tp,1),:);


%% creating RAPID file
% pathptsnew=flipud(storesort0x1);
pathptsnew=storesorts2tp;
